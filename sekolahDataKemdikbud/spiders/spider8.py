    ...
    def parse(self, response):
        if response.status == 503:
            ...
            for li_element in ul_jenjang:
                ...
                links = [
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/052900/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/052500/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/051500/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/050500/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/052200/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/050100/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/052400/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/050400/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/051300/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/050700/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/052100/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/050800/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/051000/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/051800/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/050300/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/051400/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/050900/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/051200/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/052600/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/051900/{li_text}",
                ]
