    ...
    def parse(self, response):
        if response.status == 503:
            ...
            for li_element in ul_jenjang:
                ...
                links = [
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/051100/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/052000/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/052700/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/050200/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/052300/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/052800/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/051700/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/050600/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/051600/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/056800/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/056500/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/056300/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/056200/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/056100/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/056400/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/056600/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/056700/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/056000/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/130800/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/130500/{li_text}",
                ]
