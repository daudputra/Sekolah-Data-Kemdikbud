...
class SpiderBeta(scrapy.Spider):
    ...
    def parse(self, response):
        if response.status == 503:
            ...
            for li_element in ul_jenjang:
                ...
                links = [
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/071700/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/072800/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/072400/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/072300/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/071800/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/072000/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/072100/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/070400/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/071000/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/070900/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/070800/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/071600/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/076100/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/076700/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/076000/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/076600/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/076300/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/076500/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/076400/{li_text}",
                    f"https://sekolah.data.kemdikbud.go.id/index.php/Cpetasebaran/index/076200/{li_text}"
                ]
    ...
    def parse_detail_sekolah(self, response):
        ...
        # ! data siswa
            ...
            local_path = f'json/{kabupaten_json}/{filename}'
